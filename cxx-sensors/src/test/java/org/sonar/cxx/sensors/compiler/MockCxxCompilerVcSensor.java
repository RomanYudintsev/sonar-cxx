...
public class MockCxxCompilerVcSensor extends CxxCompilerVcSensor {
  ...
  public MockCxxCompilerVcSensor(CxxLanguage language, FileSystem fs, RulesProfile profile, List<CompilerParser.Warning> warningsToProcess) {
    super(language);
