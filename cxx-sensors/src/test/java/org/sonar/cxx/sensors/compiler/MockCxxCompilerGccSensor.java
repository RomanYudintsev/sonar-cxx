...
public class MockCxxCompilerGccSensor extends CxxCompilerGccSensor {
  ...
  public MockCxxCompilerGccSensor(CxxLanguage language, FileSystem fs, RulesProfile profile, List<CompilerParser.Warning> warningsToProcess) {
    super(language);
