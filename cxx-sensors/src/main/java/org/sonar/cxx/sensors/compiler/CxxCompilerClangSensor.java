...
public class CxxCompilerClangSensor extends CxxReportSensor {
  private static final Logger LOG = Loggers.get(CxxCompilerClangSensor.class);
  ...
  public static final String DEFAULT_PARSER_DEF = CxxCompilerClangParser.COMPILER_KEY;
  public static final String DEFAULT_CHARSET_DEF = "UTF-8";
  public static final String COMPILER_KEY = "Compiler.clang";
   ...
   */
  public CxxCompilerClangSensor(CxxLanguage language, Settings settings) {
